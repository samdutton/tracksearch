var videos = {
    ...
    "x9KOS1VQgqQ": {
        "summary": "Chrome's extension system offers developers more opportunities than ever to customize and enhance users' experience on the web. New APIs are landing on a regular basis that provide new functionality and deeper hooks into Chrome itself.\nJoin us for a walk through bleeding edge changes to Chrome's extension framework that increase security, improve performance, and make it easier than ever for users to get up and running with the product of your hard work.",
        "rating": 5,
        "speakers": [
            "Mike West"
        ],
    ...
    "bsGgfUreyZw": {
        "summary": "The two creators of Dart will discuss the rationale behind Dart's design and its impact on web scalability and performance.\nThey'll also present how Dart helps developers innovate by increasing their productivity without breaking backwards compatibility.",
        "rating": 4.769231,
        "speakers": [
            "Lars Bak",
            "Kasper Lund"
    ...
    "UC9LwtA_MC8": {
        "summary": "An open forum for the Chrome/OS teams to discuss the web platform and take questions.",
        "rating": 4.714286,
        "speakers": [
            "Jeff Chang"
        ],
    ...
    "E8C8ouiXHHk": {
        "summary": "WebRTC brings webcam access, p2p, and rich audio/video communication capabilities to the browser. In this talk, we'll give an overview of the WebRTC technologies available today, show how to build WebRTC apps, and discuss the potential this technology adds to the Web Platform.",
        "rating": 4.9615383,
        "speakers": [
            "Justin Uberti"
        ],
    ...
    "VOf27ez_Hvg": {
        "summary": "Follow along as we present a history of the GWT project, the exciting new features in the GWT 2.5 release, and where we plan to take GWT in the future.",
        "rating": 4.932773,
        "speakers": [
            "Rajeev Dayal"
        ],
    ...
    "EvACKPBo_R8": {
        "summary": "Curious to learn how to port your GWT code to Dart? In this session, we will go over Dart equivalents for various GWT libraries and idioms, techniques for interoperating with existing GWT server backends, and tricks to allow Dart code to talk to existing GWT and JavaScript code.",
        "rating": 4.428571,
        "speakers": [
            "Ray Cromwell"
        ],
    ...
    "AusOPz8Ww80": {
        "summary": "Learn about new features in HTML 5 that enhance and enrich the web experience. Learn about new features in HTML 5, how they'll be supported in Chrome, and our latest plans for new functionality. The web browser is quickly evolving into a rich platform with access to all the capabilities that your computer has to offer. This talk will help you understand what is possible and how to write applications that use the latest APIs.",
        "rating": 4.7202797,
        "speakers": [
            "Matthew Papakipos"
        ],
    ...
    "Naol_TPPPL0": {
        "summary": "Learn about Google Chrome's multi-process architecture and sandboxing technology. This talk will provide an overview of the processes, threads, and IPC involved with getting pixels on the screen in a system where the WebKit rendering engine is denied, via the sandbox, from having direct access to your computer.",
        "rating": 4.3207545,
        "speakers": [
            "Darin Fisher"
        ],
    ...
    "g03bcb70kFQ": {
        "summary": "Learn how Google Chrome makes it easy to write extensions using the web technologies you already know. This talk will describe the extension system in depth, covering the anatomy of an extension, the process model, and more.",
        "rating": 4.6923075,
        "speakers": [
            "Nick Baum",
            "Aaron Boodman"
    ...
    "nv0F0k6iDB8": { //////////////// other videos begin here
    ...
    "PPXeWjWp-8Y": {
        ...
        "title": "The Breakpoint with Paul Irish and Addy Osmani—Episode 2"
    },
    "gkb_x9ZN0Vo": {
    ...
    "ktwJ-EDiZoU": {
        "summary": "In this first episode of the The Breakpoint—a show dedicated to developer tools and time-saving techniques—Paul Irish and Addy Osmani talk about Yeoman.",
        "viewCount": "14702",
        "rating": 4.89272,
        "speakers": [
            "Paul Irish",
        ...
        "title": "The Breakpoint with Paul Irish and Addy Osmani"
    },
    "lYk6oc9w8PY": {
    ...
    "iH4D2LiKbXg": {
        "summary": "Ask and vote for questions at http://goo.gl/UqEdK. Join Paul Kinlan for the second Web Intents Wednesday where he will discuss the latest and greatest Web Intents news, RSS integration, answer your questions, and show you some cool demos.",
        "viewCount": "1435",
        "rating": 5,
        "speakers": [
            "Paul Kinlan"
    ...
    "NG42lu-GEbo": {
        "summary": "Ask and vote for questions here: http://goo.gl/2b7Ds. Now that you've got a handle on what Chrome Apps are and what they can do, we're going to build an app live, and dive into the new Windowing API to show you how you can completely configure the look and feel of your Chrome App window. We'll also explain more about Content Security Policy, and how it might affect your development. Remember, we want to hear from you! What are the APIs that you're most interested and excited about? Tell us at http://goo.gl/7ZQUN so we can cover the things you're most interested in first!. Be sure to add this event to your calendar and tune in next Tuesday!",
        "viewCount": "1737",
        "rating": 4.7777777,
    ...
    "7lDQhxZII6c": {
        "summary": "A bi-weekly show about Web Intents (http://webintents.org/) hosted by Paul Kinlan with Special Guest Alex Kormorske. This week we will give an introduction to the project, a round up of interesting things that has happened in the last two weeks and also answer audience questions.",
        "viewCount": "1002",
        "rating": 4.5789475,
        "speakers": [
            "Paul Kinlan",
    ...
    "4EHKN1ywdb4": {
        "summary": "We announce that binary builds of Chromium with Dart VM are now available. Seth Ladd hosts with two guests from the Dart team, Vijay Menon and Anton Muhin. Download Dartium at http://www.dartlang.org/dartium/index.html",
        "viewCount": "4407",
        "rating": 4.3846154,
        "speakers": [
            "Seth Ladd",
    ...
    "TcaWEk2O3CM": {
        "summary": "Track: Chrome and HTML5. Time slot: G [16:30 - 17:15]. Room: 2. Level: 151. What does it mean to install a web app? This session will give an overview of how to build a beautiful application for the Chrome Web Store, monetize, and distribute it to 70 million users!",
        "viewCount": "2674",
        "rating": 4.5,
        "speakers": [
            "Eric Bidelman"
    ...
    "wRDPTnY3yO8": {
        "summary": "Karen Teng, VP Engineering of Adaptive Blue (www.getglue.com), discusses her company's experience with the Google Chrome extensions platform. To learn more on creating Google Chrome Extensions please visit code.google.com/chrome/extensions or chek out the gallery at chrome.google.com/extensions.",
        "viewCount": "45246",
        "rating": 4.773585,
        "speakers": [
            "Karen Teng"
